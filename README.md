...
<p align="center">
  <a href="https://github.com/zhanglun/wezterm-config/stargazers">
    <img alt="Stargazers" src="https://img.shields.io/github/stars/zhanglun/wezterm-config?style=for-the-badge&logo=starship&color=C9CBFF&logoColor=D9E0EE&labelColor=302D41">
  </a>
  <a href="https://github.com/zhanglun/wezterm-config/issues">
    <img alt="Issues" src="https://img.shields.io/github/issues/zhanglun/wezterm-config?style=for-the-badge&logo=gitbook&color=B5E8E0&logoColor=D9E0EE&labelColor=302D41">
  </a>
  <a href="https://github.com/zhanglun/wezterm-config/actions/workflows/lint.yml">
    <img alt="Build" src="https://img.shields.io/github/actions/workflow/status/zhanglun/wezterm-config/lint.yml?&style=for-the-badge&logo=githubactions&label=CI&color=A6E3A1&logoColor=D9E0EE&labelColor=302D41">
  </a>
</p>
...
- [**Background Image Selector**](https://github.com/zhanglun/wezterm-config/blob/master/utils/backdrops.lua)
...
- [**GPU Adapter Selector**](https://github.com/zhanglun/wezterm-config/blob/master/utils/gpu_adapter.lua)

  > :bulb: Only works if the [`front_end`](https://github.com/zhanglun/wezterm-config/blob/master/config/appearance.lua#L8) option is set to `WebGpu`.
...
- #### Steps:
  ...
  1.  ```sh
      ...
      git clone https://github.com/zhanglun/wezterm-config.git ~/.config/wezterm
      ```
